...
class ActividadesControllerTest < ActionController::TestCase
  ...
  test "should create actividade" do
    assert_difference('Actividade.count') do
      post :create, actividade: { costo: @actividade.costo, descripcion: @actividade.descripcion, duracion: @actividade.duracion, fecha: @actividade.fecha, nombre: @actividade.nombre }
    end
  ...
  test "should update actividade" do
    put :update, id: @actividade, actividade: { costo: @actividade.costo, descripcion: @actividade.descripcion, duracion: @actividade.duracion, fecha: @actividade.fecha, nombre: @actividade.nombre }
    assert_redirected_to actividade_path(assigns(:actividade))
  end
